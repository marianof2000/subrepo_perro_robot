...
class ServidorLocal(socketserver.ThreadingTCPServer):
    ...
    def _orden_gesto(self, pedido: dict) -> dict:
        ...
        # Los visores usan "saludando" para activar la animacion del saludo.
        accion = "saludando" if nombre == "saludo" else nombre
        self.mundo.gesto(accion, float(pedido.get("duracion", 2.0)))
        return {"ok": True}
